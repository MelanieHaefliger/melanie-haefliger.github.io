...
export const projects: Project[] = [
  ...
  },
  {
    ...
    period: "2023 — 2024",
    summary:
      "Connected Confluence, Slack and Google Workspace to a Slack-based AI assistant for support employees — scoping which knowledge to index, enforcing access permissions at retrieval time, and making every answer cite its source.",
    tags: ["AI / LLM", "RAG", "Access control", "Internal tooling"],
    metrics: [
      { label: "Time per ticket", value: "−30%" },
      { label: "Knowledge sources", value: "Confluence, Slack, GSuite" },
      { label: "Trust rule", value: "Source cited on every answer" },
    ],
    process: [
      ...
      { step: "04", label: "Tune", detail: "Used real usage patterns to refine which sources to include and improve answer quality over time" },
    ],
  ...
  },
  {
    ...
    tagline: "Retaining ~$500K ARR through a structured Go/No-Go risk assessment.",
    role: "Product Owner · Benevity",
    period: "2023",
    summary:
      "Discovered feature gaps between two platforms, decided which to integrate based on revenue and engagement data, mapped historical data fields, and ran a Go/No-Go risk assessment across 20 accounts to protect ~$500K ARR.",
    tags: ["Risk management", "Stakeholder alignment", "Migration", "Feature gap analysis"],
    metrics: [
      { label: "ARR retained", value: "~$500K" },
    ...
    process: [
      ...
      { step: "04", label: "Migrate", detail: "Mapped historical data fields between systems and handed CSMs a clear risk brief per account — ~$500K ARR retained" },
    ],
